  ...
  const Left_Links = [
    {
      text: 'Explore Menu',
      image: (
        <MdRestaurantMenu className="text-red-500 text-[25px] group-hover:text-white transition-all duration-300" />
      ),
    ...
    },
    {
      text: 'Ask Bite Bot',
      image: (
        <BsStars className="text-blue-500 text-[25px] group-hover:text-white transition-all duration-300" />
      ),
    ...
    },
    {
      text: 'Cart',
      image: (
        <AiOutlineShoppingCart className="text-[25px] text-purple-500 group-hover:text-white transition-all duration-300" />
      ),
  ...
  const Right_Links = [
    {
      text: 'Track Order',
      image: (
        <CiLocationOn className="text-yellow-500 text-[25px] group-hover:text-white transition-all duration-300" />
      ),
    ...
    },
    {
      text: 'Past Orders',
      image: (
        <IoMdTime className="text-green-500 text-[25px] group-hover:text-white transition-all duration-300" />
      ),
          ...
          {Left_Links.map((link, index) => {
            return (
              ...
              >
                {link.image}
                <p
                  className={`${link.text_color} font-semibold group-hover:text-white transition-all duration-300`}
                >
                  {link.text}
                </p>
              </button>
