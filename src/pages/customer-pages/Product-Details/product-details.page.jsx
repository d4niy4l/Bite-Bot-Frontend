      ...
      >
        <div className="flex flex-col md:flex-row  justify-center">
          ...
          <div className="md:w-1/2 md:mt-0 bg-[#1a1a1a] rounded-xl px-[30px] py-[20px]">
            <h1 className="text-[42px] font-bold font-mono text-logoColor">
              {product.name}
            </h1>
            ...
            <h1 className="mt-3 mb-2 text-[25px] font-semibold font-mono text-white">
              Description:
            </h1>
            <p className=" font-inter text-[18px] mb-2 ">
              {product.description}
            </p>
            <div className="mt-4">
              <h1 className="text-[25px] font-semibold font-mono text-white mt-3 mb-2">
                Ingredients:
              </h1>
              <div className="flex flex-row gap-[10px] flex-wrap mb-3">
                {product.ingredients.map((ingredient, index) => {
                  return (
                    <span
                      key={ingredient.id}
                      className={`inline-block rounded-full px-3 py-1 text-[18px] font-semibold text-white mr-2 mb-2 ${
            ...
            <h1 className="text-[25px] font-semibold font-mono text-white">
              Quantity:
            </h1>
